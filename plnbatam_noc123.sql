...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2022 at 03:19 AM
...
CREATE TABLE `distribusi` (
  ...
  `lokasipop` varchar(128) NOT NULL,
  `wilayah` varchar(128) NOT NULL,
  `distri` varchar(128) NOT NULL,
  `koordinat` varchar(128) NOT NULL,
  `otlport` varchar(128) NOT NULL,
  `spliter` varchar(128) NOT NULL
...
INSERT INTO `distribusi` (`id_pelanggan`, `lokasipop`, `wilayah`, `distri`, `koordinat`, `otlport`, `spliter`) VALUES
(1, 'Batam Center', 'Batam Center', 'Batam Center', 'Batam Center', '2', '2');

-- --------------------------------------------------------

--
-- Table structure for table `distribusiodp`
--

CREATE TABLE `distribusiodp` (
  `id_distribusi` int(11) NOT NULL,
  `odc` varchar(128) NOT NULL,
  `distribusi` varchar(128) NOT NULL,
...
--
-- Dumping data for table `distribusiodp`
--

INSERT INTO `distribusiodp` (`id_distribusi`, `odc`, `distribusi`, `core`, `koordinat`, `spliter`) VALUES
(1, '1', 'Tiban Koperasi', '2', 'Tiban Koperasi', '2');
...
INSERT INTO `maintance` (`id_maintance`, `odc`, `odp`, `pelanggan`, `koordinat`) VALUES
(1, '2', '2', 'Qatar', 'Brazil');
...
CREATE TABLE `pelanggan` (
  ...
  `odp` varchar(128) NOT NULL,
  `sinyal` varchar(128) NOT NULL,
  `paket` varchar(128) NOT NULL,
  `ont` varchar(128) NOT NULL,
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama`, `alamat`, `no_tlp`, `no_ktp`, `odp`, `sinyal`, `paket`, `ont`, `koordinat`, `isp`) VALUES
(9, 'Kevin Rivaldo', 'Tiban', '+135454554', '21344325352', '111', '11', '1 Mbps', '11', 'Tiban', '1112'),
(10, 'Wira Buana', 'Batu Aji Lama', '081261427832', '213244326558946564', 'Seraya', '2', '15 Mbps', '2', 'Batu Aji Lama', '2'),
(11, 'Skateboard', 'Los Angeles', '082262324231', '211264326558946564', 'Sei Harapan', '3', '20 Mbps', '3', 'Los Angeles', '3');
...
INSERT INTO `supplier` (`id_supplier`, `nama`, `alamat`, `no_tlp`, `no_ktp`, `odp`, `sinyal`, `paket`, `ont`, `koordinat`, `isp`) VALUES
(9, 'Kevin Rivaldo', 'Tiban Koperasi', '+135454554', '21344325352', '111', '11', '1 Mbps', '11', 'Tiban Koperasi', '1112');
...
CREATE TABLE `user` (
  ...
  `role` enum('aktivasi','admin') NOT NULL,
...
(17, 'Aktivasi PLN', 'aktivasipln', 'aktivasipln@gmail.com', '0812984949', 'aktivasi', '$2y$10$./pgdTZGg6o6JkrfsgQgj.YOFU8qvIRaYCtNMcatIZkDc6DtdwF.K', 1668993106, 'user.png', 1);
...
--
-- Indexes for table `distribusiodp`
--
ALTER TABLE `distribusiodp`
...
--
-- AUTO_INCREMENT for table `distribusiodp`
--
ALTER TABLE `distribusiodp`
...
--
ALTER TABLE `maintance`
  MODIFY `id_maintance` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
